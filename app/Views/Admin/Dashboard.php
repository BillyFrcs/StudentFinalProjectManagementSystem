          ...
          <div class="container px-6 mx-auto grid">
            ...
            >
              <div class="flex items-center">
                ...
                <span>Display student data</span>
              </div>
              ...
              <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                  ...
                  <?php 
                    ...
                    foreach ($StudentData as $data => $value):
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                      ...
                      <td class="px-4 py-3 text-xs">
                        <span
                          class="px-2 py-1 font-semibold leading-tight text-blue-700 bg-green-100 rounded-full dark:bg-blue-700 dark:text-blue-100"
                        >
                        <?= $value['Status']; ?>
                        </span>
                      </td>
                      ...
                      <td class="px-4 py-3">
                        <div class="flex items-center space-x-4 text-sm">
                          <a href="<?php echo '/Admin/Edit/' . $value['StudentID']; ?>"
                          ...
                          <button type="button"
                            class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                            aria-label="Delete" onclick="Delete('<?= $value['StudentID']; ?>')"  
                          >
                            <svg
                              class="w-5 h-5"
                              aria-hidden="true"
